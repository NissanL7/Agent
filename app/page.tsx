...
export default function Home(){
 ...
 const active=useMemo(()=>chats.find(c=>c.id===activeId)||null,[chats,activeId]); const activeMessages=active?.messages??[]
 ...
 useEffect(()=>{bottomRef.current?.scrollIntoView({behavior:'smooth',block:'end'})},[activeMessages.length,busy])
 ...
 function copyWholeChat(){if(!activeMessages.length||!active)return;copyText(chatAsText(active),'Whole chat copied')}
